...
//<<<<<<
            ...
            String sql ="UPDATE partido SET fecha = ?, equipo1 = ?, puntos_equipo1 = ?, equipo2 = ? ,puntos_equipo2=?,tipo_partido=? WHERE id = ?";
            ...
            System.out.println("SOCIOS EDITADOS:  " + filasAfectadas);
